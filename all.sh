...
echo "\033[32;1mAuthor : Mr-Jucky"
echo "\033[37;1mFeat: Latip AyYee"
echo "\033[35;1mversion Tools: 7"
echo "\033[35;1mTeam : GITONGCYP"
echo "\033[33;1mKontak Me :  Chenglie Ching"
echo "\033[31;1mPlease For Subcribe Youtube:"
echo "\033[92mBuka Cara" 
echo "\033[36;1mIndonesia Security Lite"
echo "\033[34;1m[$]\033[36;1m============================\033[34;1m[$]"
echo ""
echo "\033[32;1mPilih mki bozzque:"
echo "\033[36;1m"
echo "[===============================================[>"
...
echo " "
echo $cyan "201.> Rusmana-ID 68 SC"
echo " "
echo $cyan "202.> Auto report fb v2"
echo " "
echo $cyan "203.> Sms gratis all operator"
echo " "
...
then
clear
toilet -f mono12 -F gay "Mr-Jucky"
php phd.php
fi
...
then
clear
toilet -f standard -F gay "Mr-Jucky" 
...
clear
echo "\033[34;1m"
cowsay -f kiss.cow "Mr-Jucky" | lolcat
figlet -f slant Mr-Jucky
echo "\033[37;1m"
...
then
clear
cowsay -f sheep.cow "Mr-Jucky" | lolcat
figlet "Mr-Jucky" | lolcat
sleep 1
cd
cd module
...
echo "\033[32;1mPepuro Manyoosss"
...
clear
echo "\033[31;1m"
cowsay ghostbusters.cow "Mr-Jucky" 
figlet "Mr-Jucky" | lolcat
apt update && apt upgrade
apt install python2
apt install python
...
then
clear
toilet -f big -F gay "Mr-Jucky " | lolcat
sleep 1
...
then
clear
git clone http://github.com/rusmana-id/rus
mv rus $HOME
cd $HOME/rus
bash v2.sh
fi
...
chmod +x ./install
./install
echo $red "formatnya : smsid send nomor pesan"
sleep 1
echo $red "contoh : smsid send 082291566*** hyy"
sleep 1
echo $red"catatan : jika pada pesan terdapat spasi, anda hanya perlu memasukkan pesan kedalam tanda petik dua ("")"
sleep 1
fi
